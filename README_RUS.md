...
##### Остановить докер контейнер через `docker stop [container_id|container_name]`.
##### Проверить, что контейнер остановился через `docker ps`.
...
##### Запустить локально **nginx** с написанной конфигурацией.
